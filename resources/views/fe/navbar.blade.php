                        ...
                        <ul class="dropdown-menu dropdown-menu-end dropdown-reservasi" aria-labelledby="reservasiDropdown" style="border: 1px solid rgba(5, 195, 251, 0.2); border-radius: 12px; overflow: hidden; box-shadow: 0 12px 40px rgba(5, 195, 251, 0.15); background: linear-gradient(135deg, rgba(255,255,255,0.98) 0%, rgba(240, 247, 255, 0.95) 100%); margin-top: 12px;">
                            @auth
                                <li class="dropdown-header" style="background: linear-gradient(135deg, #1F3BB3 0%, #0a5c9f 100%); color: white; padding: 1rem; border-bottom: 2px solid rgba(5, 195, 251, 0.2);">
                                    <h6 style="margin: 0; font-weight: 800; font-size: 0.95rem;"><i class="fas fa-history me-2"></i>Riwayat Pesanan</h6>
                                ...
                                @if(Auth::user()->pelanggan)
                                    @forelse(Auth::user()->pelanggan->reservasi()->orderBy('created_at', 'desc')->take(5)->get() as $reservasi)
                                        <li class="reservasi-item" style="padding: 0.75rem 1rem; border-bottom: 1px solid rgba(5, 195, 251, 0.1); transition: all 0.3s ease;" onmouseover="this.style.backgroundColor='rgba(5, 195, 251, 0.08)'; this.style.paddingLeft='1.25rem'" onmouseout="this.style.backgroundColor='transparent'; this.style.paddingLeft='1rem'">
                                            <a href="{{ route('pesanan.index', $reservasi->id) }}" class="dropdown-item" style="padding: 0; border: none; background: transparent;">
                                                <div class="d-flex justify-content-between align-items-center">
                                                    <div>
                                                        ...
                                                        <small style="color: #666;">Kode: {{ $reservasi->id_paket }}</small>
                                                    </div>
                                                    <div class="text-end">
                                    ...
                                    @empty
                                        <li class="text-center text-muted py-3">
                                            ...
                                            <p style="margin-top: 8px; font-size: 0.9rem; color: #999;">Tidak ada reservasi</p>
                                        </li>
                                    @endforelse
                                @else
                                    <li class="text-center text-muted py-3">
                                ...
                                <li style="background: linear-gradient(135deg, #f0f7ff 0%, rgba(5, 195, 251, 0.05) 100%); padding: 1rem; text-align: center;">
                                    <a href="{{ route('pesanan.index') }}" style="color: #1F3BB3; text-decoration: none; font-weight: 700; transition: all 0.3s ease; display: inline-block;" onmouseover="this.style.color='#05C3FB'" onmouseout="this.style.color='#1F3BB3'">Lihat Semua Pesanan →</a>
                                </li>
                            @else
                                <li class="text-center text-muted py-3">
                                    <i class="fas fa-lock" style="font-size: 1.5rem; color: #ccc;"></i>
                                    <p style="margin-top: 8px; font-size: 0.9rem; color: #999;">Silakan login untuk melihat reservasi</p>
                                </li>
                            @endauth
                        </ul>
                    </li>
