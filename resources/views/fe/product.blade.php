    ...
    <div class="container">
        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 30px;">
            <div style="text-align:left;">
                ...
                <i class="fas fa-hand-holding-heart" style="color: #007bff; margin: 0 12px; font-size: 22px; vertical-align: middle;"></i>
                <span style="font-size: 22px; font-weight: 700; color: #333; vertical-align: middle;">Paket</span>
                <span style="display: inline-block; border-top: 2px solid #28a745; width: 50px; vertical-align: middle;"></span>
            </div>
            <a href="{{ route('paket') }}" class="btn btn-dark btn-sm rounded-pill" style="font-weight:600;">Lihat Semua</a>
        </div>
            ...
            <div class="col-md-3 mb-4">
                <div class="card h-100 shadow-sm border-0 position-relative product-card" style="transition:transform .2s;">
                    ...
                    <a href="{{ route('paket.detail', $paket->id) }}">
                        <img src="{{ asset('storage/' . $paket->foto1) }}" class="card-img-top" alt="{{ $paket->nama_paket }}" style="width:100%; height:200px; object-fit:cover; border-radius:8px 8px 0 0;">
                    </a>
                    <div class="card-body d-flex flex-column">
                        ...
                        <p class="card-text mb-2" style="color:#555; min-height:40px;">{{ \Illuminate\Support\Str::limit($paket->deskripsi, 50) }}</p>
                        <div class="mb-2">
                            @if($diskon && $diskon->persen > 0)
                        ...
                        <div class="mt-auto">
                            <a href="{{ route('paket.detail', $paket->id) }}" class="btn btn-dark btn-sm rounded-pill w-100" style="font-weight:600;">Order Now</a>
                        </div>
                    </div>
                </div>
            </div>
