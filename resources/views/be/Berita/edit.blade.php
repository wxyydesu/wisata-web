            ...
            <div class="col-md-12 grid-margin">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{ route('berita_update', $news->id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="form-group">
                                ...
                                <input type="datetime-local" class="form-control" id="tgl_post" name="tgl_post" 
                                       value="{{ old('tgl_post', isset($news->tgl_post) ? \Carbon\Carbon::parse($news->tgl_post)->format('Y-m-d\TH:i') : '') }}" required>
                                @error('tgl_post')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
