...
<div class="main-panel">
    <div class="content-wrapper">
        <div class="d-flex justify-content-between align-items-center mb-3">
            <h4 class="card-title">{{ $greeting }}, here's your Paket Wisata Management</h4>
            <a href="{{ route('paket_create') }}" class="btn btn-primary">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group" role="group">
                                                <button type="button" class="btn btn-dark btn-sm" onClick="window.location.href='{{ route('paket_edit', $paket->id) }}'">
                                                    <i class="fa fa-pencil-square-o"></i> Edit
                                                </button>
                                                <form action="{{ route('paket_destroy', $paket->id) }}" method="POST" style="display: inline;">
                                                    @csrf
                                                    @method('DELETE')
